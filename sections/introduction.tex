...
The three basic types---often called 0, 1, and 2---in MLTT here will be denoted
with their more common names: \(\bot\), \(\top\), and \(\mathbf{Bool}\),
respectively.
\begin{figure}[h!]
  \begin{multicols}{3}
    \begin{agdalisting}
    ...
    \end{agdalisting}
  \end{multicols}
  \caption{Agda Definitions of the Three Basic Types}
\end{figure}
\subsubsection{Dependent Sums}
Dependent sums are denoted with the usual \(\Sigma\) symbol, and are defined in
Fig.~\ref{sigma-def}.
\begin{figure}[h!]
  \begin{multicols}{2}
    \begin{agdalisting}
    ...
    \end{agdalisting}
  \end{multicols}
  \caption{Agda Definitions of Dependent Sums}
  \label{sigma-def}
\end{figure}
