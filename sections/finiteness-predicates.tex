...
\begin{lemma} \label{split-enum-pi}
...
The other implication of this truncation is that the type we have defined does
not, in fact, imply decidable equality unlike all of those we have seen so far.
