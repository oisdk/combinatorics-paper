...
equal to \(x\)''.
\todo{Probably should put back in some instances here, i.e. bool and top.
  Obviously not the full closure stuff, but one or two instances would be
  instructive.}
