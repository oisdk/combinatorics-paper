...
\section{Manifest Bishop Finiteness}
...
\begin{proof}
  ...
  has decidable equality, by Hedburg's theorem \todo{ref here} it is a set,
...
\end{proof}
\section{Manifest Enumerability}
Since we have now discovered that all three predicates defined so far have equal
restrictiveness, the clear next step is to 

So far, we have pushed finiteness predicates in the direction of making them
``less informative'': we have not, however, 
...
\section{Split Enumerability and Manifest Bishop Finiteness}
\section{Split Enumerability and Manifest Enumerability}
...
\section{Manifest Bishop Finiteness and Cardinal Finiteness}
...
\section{Cardinal Finiteness and Kuratowski Finiteness}
