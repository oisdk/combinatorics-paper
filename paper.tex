...
way.
For instance, while lists would usually be defined like so:
\begin{equation}
  \begin{aligned}
    \mathbf{List}(A) &= \\
  ...
  \end{aligned}
\end{equation}
We could equivalently define them as a container:
\begin{equation}
  \mathbf{List}(A) = \left\llbracket \mathbb{N} , \mathbf{Fin} \right\rrbracket
\end{equation}

The two representations are equivalent, and they lead to two versions of split
enumerability which are equivalent.
