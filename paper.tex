...
\begin{rm-definition}[List Membership] \label{list-membership}
  \begin{equation}
...
\begin{rm-definition}[Lists as an Inductive Type]
  \begin{equation}
    \begin{aligned}
      \mathbf{List}(A) &= \\
...
However, as we will see, it will be occasionally more convenient to work with an
...
\end{rm-lemma}
\begin{proof}
\todo[inline]{Agda code for proof?}
\end{proof}
...
\begin{rm-lemma} \label{container-split-enum-surj}
...
\begin{rm-definition}[Unique List Membership]
