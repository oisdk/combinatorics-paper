...
\begin{rm-theorem}
  ...
  \begin{equation}
    \Pi {(x : A)} , \mathcal{B}\left( U(x) \right)
  \end{equation}
...
\end{rm-lemma}
\begin{proof}
  Though this proof is surprisingly complex, it is a well-known puzzle in
