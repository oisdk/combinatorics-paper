...
is manifest enumerable (lemma~\ref{manifest-bishop-to-manifest-enum}).
...
(lemma~\ref{manifest-enum-to-manifest-bishop}).
...
\begin{romlemma} \label{manifest-bishop-to-manifest-enum}
  Any manifestly Bishop finite type is manifestly enumerable.
\end{romlemma}
\begin{romlemma} \label{manifest-enum-to-manifest-bishop}
