...
\maketitle
\begin{abstract}
  We study finiteness in Homotopy Type Theory, classifying five fundamentally
  different finiteness predicates and proving formally the relationship between
  them.
  We also prove the closure properties of each predicate, which includes a proof
