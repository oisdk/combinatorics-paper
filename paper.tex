...
We will provide a definition for each, and prove each relation to the other
finiteness predicates.
In terms of Figure~\ref{finite-classification}, this means providing a function
to inhabit each arrows.
...
\begin{itemize}
  \item Relation between different versions of finiteness, especially card to
    bishop.
  \item Topos for Kuratowski
  \item Countable and W-topos
  \item Search
\end{itemize}
