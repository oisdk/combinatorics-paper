...
%<*semigroup>
\begin{code}
record  Semigroup ℓ : Type (ℓ-suc ℓ) where
  infixl 6 _∙_
  field
    𝑆      : Type ℓ
    _∙_    : 𝑆 → 𝑆 → 𝑆
...
%<*monoid>
\begin{code}
record  Monoid ℓ : Type (ℓ-suc ℓ) where
  infixl 6 _∙_
  field
    𝑆      : Type ℓ
    _∙_    : 𝑆 → 𝑆 → 𝑆
...
record CommutativeMonoid ℓ : Type (ℓ-suc ℓ) where
  field
    monoid : Monoid ℓ
  open Monoid monoid public
  field
...
record Semilattice ℓ : Type (ℓ-suc ℓ) where
  field
...
record NearSemiring ℓ : Type (ℓ-suc ℓ) where
  infixl 6 _+_
  infixl 7 _*_
  field
    𝑅 : Type ℓ
...
record Semiring ℓ : Type (ℓ-suc ℓ) where
  field
...
record IdempotentSemiring ℓ : Type (ℓ-suc ℓ) where
  field
    semiring : Semiring ℓ
...
record CommutativeSemiring ℓ : Type (ℓ-suc ℓ) where
  field
    semiring : Semiring ℓ
  open Semiring semiring public
  field
...
record LeftSemimodule ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
    semiring : Semiring ℓ₁
  open Semiring semiring public
  field
...
record StarSemiring ℓ : Type (ℓ-suc ℓ) where
  field
    semiring : Semiring ℓ
  open Semiring semiring public
  field
...
\end{code}
\begin{code}
record Functor ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
    𝐹   : Type ℓ₁ → Type ℓ₂
    map : (A → B) → 𝐹 A → 𝐹 B
...
record Applicative ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
    functor : Functor ℓ₁ ℓ₂
...
record Monad ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
...
record Alternative ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
    applicative : Applicative ℓ₁ ℓ₂
  open Applicative applicative public
  field
...
record MonadPlus ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
    monad : Monad ℓ₁ ℓ₂
...
record Foldable ℓ₁ ℓ₂ : Type (ℓ-suc (ℓ₁ ℓ⊔ ℓ₂)) where
  field
    𝐹 : Type ℓ₁ → Type ℓ₂
  open Monoid ⦃ ... ⦄
  field
